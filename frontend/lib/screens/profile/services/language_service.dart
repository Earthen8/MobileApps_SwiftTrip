...
class AppStrings {
  static const Map<String, Map<String, String>> values = {
    'en': {
      ...
      'have_coupon_hint': 'Have a coupon code?',
      'cancel_button': 'Cancel',
      'use_button': 'Use',
      'copied_toast': 'copied!',
      'copy_button': 'COPY',
      'coupon_collected': 'Coupon successfully added to your account!',
      'coupon_collect_failed': 'Failed to collect coupon. Please try again.',
    ...
    'id': {
      ...
      'coupon_label': 'Kode Kupon',
      'have_coupon_hint': 'Punya kode kupon?',
      'cancel_button': 'Batal',
      'use_button': 'Gunakan',
      'copied_toast': 'tersalin!',
      'copy_button': 'SALIN',
      'coupon_collected': 'Kupon berhasil ditambahkan ke akun Anda!',
      'coupon_collect_failed': 'Gagal mengambil kupon. Silakan coba lagi.',
