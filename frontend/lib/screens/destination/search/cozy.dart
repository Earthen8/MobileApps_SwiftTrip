    ...
    setState(() {
      _items = [
        DestinationModel(
          ...
          price: 1500000,
          features: ['Mountain View', 'Cozy Stay', 'Pine Forest'],
          isFavorite: true,
        ),
        DestinationModel(
          id: 'co-2',
          ...
          price: 5500000,
          features: ['Sustainable Luxury', 'Rustic Heart'],
          hasDiscount: true,
        ),
        DestinationModel(
          id: 'co-3',
          ...
          price: 1200000,
          features: ['Urban Retreat', 'Coffee Experience'],
        ),
        DestinationModel(
          id: 'co-4',
          ...
          price: 3800000,
          features: ['Historic Plantation', 'Central Java Vibe'],
          isFavorite: true,
        ),
      ];
      _isLoading = false;
